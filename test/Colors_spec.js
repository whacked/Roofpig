...
describe("Colors", function() {
  describe("of", function() {
    it("has default values", function() {
      const colors = new Colors(new Pov(), "", "", "");
    ...
    return it("can change colors", function() {
      const colors = new Colors(new Pov(), "", "", "", "R:o L:#abc solved:r c:#123");
  ...
  describe("#to_draw", function() {
    ...
    it("colors only specified stickers", function() {
      const colors = new Colors(new Pov(), "U*", "");
      expect(colors.to_draw('UFR', 'F')).to.deep.equal({color: colors.of('F'), hovers: true});
    ...
    it("solved overrides colored", function() {
      const colors = new Colors(new Pov(), "U*", "F*");
    ...
    it("last tweak color wins", function() {
      const colors = new Colors(new Pov(), "*", "", "R:U* L:F*");
    ...
    return describe("tweaks", function() {
      it("sets X and colors", function() {
        const colors = new Colors(new Pov(), "", "*", ".Xx:uFR  D.L:UfR");
      ...
      return it("overrides colored and solved", function() {
        const colors = new Colors(new Pov(), "U*", "D*", "L:U  R:D");
  ...
  return describe("side pov adjustments", function() {
    it("side colors", function() {
      const plain_colors = new Colors(new Pov(), "", "", "");
      const pov_colors = new Colors(new Pov(new Move("S")), "", "", "");
      expect(pov_colors.of('F')).to.equal(plain_colors.of('F'));
      return expect(pov_colors.of('R')).to.equal(plain_colors.of('U'));
    });

    it("colored", function() {
      const colors = new Colors(new Pov(new Move("S")), "u", "", "");
    ...
    it("solved", function() {
      const colors = new Colors(new Pov(new Move("S")), "Ufr", "r", "");
    ...
    return it("tweaks", function() {
      const untweaked = new Colors(new Pov(new Move("S")), "", "", "");
      ...
      const tweaked = new Colors(new Pov(new Move("S")), "", "", "X:Uf RF:DL");
