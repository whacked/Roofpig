...
var Layer = (function() {
  ...
  Layer = class Layer {
    static initClass() {
      ...
      this.U = new Layer('U', v3( 0, 0, 1), ['UBR','UBL','UFL','UFR'],['UR','UB','UL','UF'], ['U'], {F:'R', R:'B', B:'L', L:'F', U:'U', D:'D'});
      this.D = new Layer('D', v3( 0, 0,-1), ['DFR','DFL','DBL','DBR'],['DF','DL','DB','DR'], ['D'], {F:'L', L:'B', B:'R', R:'F', U:'U', D:'D'});
